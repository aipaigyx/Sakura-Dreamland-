...
(function() {
    tinymce.addI18n('zh_CN', {
        ...
        "Name": "名称",
        "Id": "ID",
        "Id should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.": "ID 应该以字母开头，后面只能跟字母、数字、破折号、点、冒号或下划线。",
        ...
        "Words": "单词",
        "Characters": "字符",
        "Characters without spaces": "不包含空格",
        "Insert video": "插入视频",
        "Embed URL": "嵌入URL",
        "Dimensions": "尺寸",
        "Poster": "封面",
