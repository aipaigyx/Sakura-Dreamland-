...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($current_password) || empty($new_password) || empty($confirm_password)) {
        ...
        $result = db_exec($update_sql, [$hashed_password, $user_id]);
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1">
                <div class="glass-morphism rounded-2xl p-6">
                    ...
                    <nav class="space-y-2">
                        ...
                        <a href="password.php" class="block px-4 py-3 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-lg font-medium">
                            <i class="fas fa-lock mr-2"></i>修改密码
                        </a>
            ...
            <div class="lg:col-span-2">
                <div class="glass-morphism rounded-2xl p-6">
                    ...
                    <!-- 修改密码表单 -->
                    <form method="POST" action="password.php" class="space-y-6">
                        <!-- 当前密码 -->
                        <div>
